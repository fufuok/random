...
func TestRandInt(t *testing.T) {
	t.Parallel()
	utils.AssertEqual(t, true, RandInt(1, 2) == 1)
	utils.AssertEqual(t, true, RandInt(-1, 0) == -1)
	utils.AssertEqual(t, true, RandInt(0, 5) >= 0)
	utils.AssertEqual(t, true, RandInt(0, 5) < 5)
	utils.AssertEqual(t, 2, RandInt(2, 2))
	utils.AssertEqual(t, 2, RandInt(3, 2))
}

func TestRandUint32(t *testing.T) {
	t.Parallel()
	utils.AssertEqual(t, true, RandUint32(1, 2) == 1)
	utils.AssertEqual(t, true, RandUint32(0, 5) < 5)
	utils.AssertEqual(t, uint32(2), RandUint32(2, 2))
	utils.AssertEqual(t, uint32(2), RandUint32(3, 2))
}

func TestFastIntn(t *testing.T) {
	t.Parallel()
	for i := 1; i < 10000; i++ {
		utils.AssertEqual(t, true, FastRandn(uint32(i)) < uint32(i))
		utils.AssertEqual(t, true, FastIntn(i) < i)
	}
	utils.AssertEqual(t, 0, FastIntn(-2))
	utils.AssertEqual(t, 0, FastIntn(0))
	utils.AssertEqual(t, true, FastIntn(math.MaxUint32) < math.MaxUint32)
	utils.AssertEqual(t, true, FastIntn(math.MaxInt64) < math.MaxInt64)
}
...
func TestRandString(t *testing.T) {
	...
	utils.AssertEqual(t, 777, len(a))
	utils.AssertEqual(t, false, a == b)
	utils.AssertEqual(t, "", RandString(-1))
}
...
func TestRandBytes(t *testing.T) {
	...
	utils.AssertEqual(t, 777, len(a))
	utils.AssertEqual(t, 777, len(b))
	utils.AssertEqual(t, false, bytes.Equal(a, b))
}
...
func TestRandHex(t *testing.T) {
	t.Parallel()
	utils.AssertEqual(t, 32, len(RandHex(16)))
	utils.AssertEqual(t, 14, len(RandHex(7)))
}
